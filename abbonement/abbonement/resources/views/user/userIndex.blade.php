                            ...
                            <table id="staffs" class="table table-bordered table-striped">
                                ...
                                <tr>
                                    @foreach ($users as $user)
                                        ...
                                        $image = ($media->isEmpty() ? 'https://img.freepik.com/vecteurs-libre/cercle-bleu-utilisateur-blanc_78370-4707.jpg?t=st=1728560652~exp=1728564252~hmac=ddc44fc5bd3ceb49325937bba9a8a7fcf42fe0c863b7a36c7e32feb69f681140&w=740' : url($media[0]->getUrl('thumb')));
                                        ?>
                                        <td class="text-center img-width"><img src="{{ $image }}"></td>
